...
type
  ...
  private
    ...
    FAutoSearchMappedClasses: Boolean;
  ...
  public
    ...
    // If true, all classes with [Entity] annotation that the program uses
    // are automatically added to the framework's MappedClasses.
    property AutoSearchMappedClasses: Boolean read FAutoSearchMappedClasses write FAutoSearchMappedClasses;
