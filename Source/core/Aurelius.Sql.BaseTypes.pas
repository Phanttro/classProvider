...
type
  ...
  public
    function Clone: TSQLFieldDefinition;
    ...
    constructor Create(AFieldName: string; ANotNull: Boolean;
      AFieldType: TFieldType; ALength, APrecision, AScale: Integer; AAutoGenerated: boolean);
  end;
...
function TSQLFieldDefinition.Clone: TSQLFieldDefinition;
begin
  Result := TSQLFieldDefinition.Create(FieldName, NotNull, FieldType,
    Length, Precision, Scale, AutoGenerated);
end;

constructor TSQLFieldDefinition.Create(AFieldName: string; ANotNull: Boolean;
  AFieldType: TFieldType; ALength, APrecision, AScale: Integer; AAutoGenerated: boolean);
begin
