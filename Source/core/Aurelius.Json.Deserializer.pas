...
begin
  ...
  case MemberInfo.RealType.TypeKind of
    ...
    tkFloat:
      case Value.ValueType of
        TJsonType.JString:
          MemberValue := TValue.From<double>(StrToFloat(Value.StringValue)).Cast(MemberInfo.MemberType.Handle);
        TJsonType.JInteger:
          MemberValue := TValue.From<double>(Value.IntValue).Cast(MemberInfo.MemberType.Handle);
        TJsonType.JFloat:
          MemberValue := TValue.From<double>(Value.FloatValue).Cast(MemberInfo.MemberType.Handle);
      else
        Error;
      end;
