...
begin
  ...
  FSlGeradora.Add('  Vcl.ComCtrls,');
  FSlGeradora.Add('  untFuncoes,');
  FSlGeradora.Add('  untSearcher;');
  FSlGeradora.Add('');
  FSlGeradora.Add('type');
  FSlGeradora.Add('  TControle' + FTabelaClasse + ' = Class(TBaseControle<T' + FTabelaClasse + ', T' + FTabelaClasse + 'DAO>)');
  FSlGeradora.Add('  private');
  ...
  FSlGeradora.Add('    function Listar(AWhere: TWhere): TList<T' + FTabelaClasse + '>; overload;');
  FSlGeradora.Add('    function Listar(AWhereList: TList<TWhere>): TList<T' + FTabelaClasse + '>; overload;');
  FSlGeradora.Add('    function Listar(AFieldName: String; AValorAPesquisar: Variant;');
  FSlGeradora.Add('      AOperadorComparativo: TOperadorComparativo): TList<T' + FTabelaClasse + '>; overload;');
  FSlGeradora.Add('  end;');
  FSlGeradora.Add('');
  FSlGeradora.Add('implementation');
  FSlGeradora.Add('');
  ...
  begin
    ...
    if FClientDataSet.FieldByName('IS_NULLABLE').AsString = 'N' then begin
      if (Pos('int', FClientDataSet.FieldByName('DATA_TYPE').AsString) > 0) or
        ...
        FSlGeradora.Add('    if (Assigned(Sender)) and (Sender is TForm) then');
        FSlGeradora.Add('      TFunc.ComponentSetFocus(TForm(Sender).FindComponent(''edt' + FClientDataSet.FieldByName('COLUMN_NAME').AsString + '''));');
        FSlGeradora.Add('');
  ...
  FSlGeradora.Add('end;');
  FSlGeradora.Add('');
  FSlGeradora.Add('function TControle' + FTabelaClasse + '.Listar(AWhere: TWhere): TList<T' + FTabelaClasse + '>;');
  FSlGeradora.Add('begin');
  FSlGeradora.Add('  Result := Self.Listar<T' + FTabelaClasse + '>(AWhere);');
  FSlGeradora.Add('end;');
  FSlGeradora.Add('');
  FSlGeradora.Add('function TControle' + FTabelaClasse + '.Listar(');
  FSlGeradora.Add('  AWhereList: TList<TWhere>): TList<T' + FTabelaClasse + '>;');
  FSlGeradora.Add('begin');
  FSlGeradora.Add('  Result := Self.Listar<T' + FTabelaClasse + '>(AWhereList);');
  FSlGeradora.Add('end;');
  FSlGeradora.Add('');
  FSlGeradora.Add('function TControle' + FTabelaClasse + '.Listar(AFieldName: String; AValorAPesquisar: Variant;');
  FSlGeradora.Add('  AOperadorComparativo: TOperadorComparativo): TList<T' + FTabelaClasse + '>;');
  FSlGeradora.Add('begin');
  FSlGeradora.Add('  Result := Self.Listar<T' + FTabelaClasse + '>(TWhere.Create(AFieldName, AValorAPesquisar, AOperadorComparativo));');
  FSlGeradora.Add('end;');
  FSlGeradora.Add('');
